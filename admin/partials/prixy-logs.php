...
<div class="wrap prixy-admin">
    ...
    <div class="dpu-card" style="padding:0;overflow:hidden;">
        ...
        <div class="dpu-logs-table-wrap" id="prixy-log-table" style="padding:1.25rem 1.5rem;"></div>
    </div>

</div><!-- .prixy-admin -->

<!-- Modal: Detalles de ejecución (reutilizado desde dashboard) -->
<div id="prixy-run-details-modal" class="hidden dpu-modal-overlay">
    <div class="dpu-modal dpu-modal--lg">
        <div class="dpu-modal__header">
            <h3 class="dpu-modal__title">Detalles de la ejecución</h3>
            <button id="prixy-close-details-modal" class="dpu-modal__close">
        ...
        <div class="dpu-modal__body">
            <div id="prixy-run-details-content"></div>
        </div>
        <div class="dpu-modal__footer">
            <button id="prixy-close-details-modal-2" class="dpu-btn dpu-btn--ghost">Cerrar</button>
        </div>
    </div>
</div>
