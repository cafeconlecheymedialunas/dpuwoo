 ...
 * php wp-content/plugins/dpuwoo/tests/reset-test.php
 */
...
$wpdb->query("DELETE FROM {$wpdb->postmeta} WHERE meta_key = '_dpuwoo_regular_price_usd'");
$wpdb->query("DELETE FROM {$wpdb->postmeta} WHERE meta_key = '_dpuwoo_sale_price_usd'");
$wpdb->query("DELETE FROM {$wpdb->postmeta} WHERE meta_key = '_dpuwoo_first_setup_done'");
